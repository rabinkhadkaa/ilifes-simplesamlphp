...
$metadata['https://ilifes.store/simplesaml/module.php/saml/sp/metadata.php'] = [
    'AssertionConsumerService' => 'https://ilifes.store/simplesaml/module.php/saml/sp/saml2-acs.php/default-sp',
    'SingleLogoutService' => 'https://ilifes.store/simplesaml/module.php/saml/sp/saml2-logout.php/default-sp',
    'NameIDFormat' => 'urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress',
];
