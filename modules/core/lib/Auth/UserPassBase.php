...
require '/var/www/simplesamlphp/functions.php';
logSSOFlow("UserPassBase: Starting user authentication. File:" . __FILE__);
...
abstract class UserPassBase extends \SimpleSAML\Auth\Source
{
	...
	require '/var/www/simplesamlphp/functions.php';
	logSSOFlow("UserPassBase: Authentication successful for user ' . $username. File:" . __FILE__);
